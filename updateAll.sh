...
cat $ARCHIVE_HOME/logs/titleObjects.txt | parallel --jobs 5 ./updatePid.sh {} https://api.edoweb-test.hbz-nrw.de $yesterday  >$ARCHIVE_HOME/logs/lobidify-`date +"%Y%m%d"`.log 2>&1
